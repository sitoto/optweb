...
INTERNAL_IPS = ('127.0.0.1','192.168.2.41','172.23.1.10',)
...
DATABASES = {
    'default': {
        ...
        'NAME': 'anydb',                      # Or path to database file if using sqlite3.
        'USER': 'anyone',                      # Not used with sqlite3.
        'PASSWORD': 'anyone&*(0',                  # Not used with sqlite3.
        'HOST': '172.23.6.238',                      # Set to empty string for localhost. Not used with sqlite3.
